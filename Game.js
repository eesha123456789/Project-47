...
function angryBirdSetup(){
  ...
  sling=new Slingshot(bird.body,{x:325,y:430})
}
...
function mouseReleased(){
  ...
  birdFly.play();
  Matter.Body.setPosition(bird,{x:bird.position.x,y:bird.position.y})
  sling.fly();
  }
}
function keyPressed(){
